...
def dcv(request):
    ...
    if settings.EVENT_LOG_NAME != ":notset:":
        ...
        if request.method == 'POST':
            ...
            if getTimeLabel(log_df) in selection_list[2:] or 'case:duration' in selection_list[2:] or ('case:duration' in selection_list[:2] and not case_label in selection_list[:2]):
